...
plt.plot(low_new, '-', color = 'b', alpha = 0.5)
plt.plot(high_new, '-', color = 'r', alpha = 0.5)
plt.gca().fill_between(range(len(low_new)), low_new, high_new, 
                       color='grey', 
                       alpha=0.10, label = '_nolegend_')

plt.xlabel('Month')
plt.ylabel('Temperture in °C')
plt.title('2015 Ann Arbor Daily Temperature ')
...
plt.scatter(new_low, low_2015.iloc[new_low], s=15, c='blue')
plt.scatter(new_high, high_2015.iloc[new_high], s=15, c='red')
